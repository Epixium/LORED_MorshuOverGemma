...
const MOD_KEY: String = "epixium_morshu"
...
static var instance: EpixiumMorshu
...
func _on_mods_loaded() -> void:
	...
	refresh_all()
	ResourceLoader.load("res://groups/currency/icons/stage 1/cash shop/gem.png", "", ResourceLoader.CACHE_MODE_REPLACE)
	ResourceLoader.load("res://groups/lored/loreds/stage 1/cash shop/gem/gem_idle.png", "", ResourceLoader.CACHE_MODE_REPLACE)
	ResourceLoader.load("res://groups/lored/loreds/stage 1/cash shop/gem/animation/gem.tres", "", ResourceLoader.CACHE_MODE_REPLACE)
